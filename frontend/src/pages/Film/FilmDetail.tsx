              ...
              <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap' }}>
                ...
                <Button 
                  ...
                  sx={{
                    borderRadius: 2,
                    px: 3,
                    borderColor: followed ? 'primary.main' : alpha(theme.palette.text.primary, 0.3),
      ...
      <Container maxWidth="lg" sx={{ py: 6 }}>
        <Grid container spacing={6}>
                              ...
                              <ButtonBase
                                ...
                                sx={{
                                  ...
                                  '&:hover': {
                                    ...
                                    boxShadow: theme.palette.mode === 'dark' ? '0 4px 14px rgba(0,0,0,0.35)' : '0 4px 14px rgba(0,0,0,0.15)',
                  ...
                  <Grid size={{ xs: 6, sm: 4 }} key={cast.id}>
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                      <Avatar 
                        ...
                        sx={{ width: 56, height: 56, border: '2px solid', borderColor: alpha(theme.palette.text.primary, 0.1) }}
                      />
                      <Box>
          ...
          <Grid size={{ xs: 12, md: 4 }}>
            <Paper sx={{ p: 3, borderRadius: 4, bgcolor: alpha(theme.palette.text.primary, 0.03), border: '1px solid', borderColor: alpha(theme.palette.text.primary, 0.05) }}>
              ...
              <Box sx={{ textAlign: 'center', py: 2 }}>
                <Rating
                  ...
                  emptyIcon={<Star style={{ color: theme.palette.action.disabled }} fontSize="inherit" />}
                />
