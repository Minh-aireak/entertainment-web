...
const Message = () => {
  ...
  useEffect(() => {
    const userId = currentUser.result.userId;
    if (userId) {
      socketIoService.connect();
      socketIoService.on("message", handleIncomingMessage);
    }
    return () => {
  ...
  const handleIncomingMessage = (message: any) => {
    ...
    try {
      if (typeof incoming === "string") {
        ...
        if (incoming.sender.userId !== currentUser.result.userId) {
          incoming.me = false;
        }
      }
    } catch (e) {
            ...
            >
              ...
              >
                <Stack direction="row" alignItems="center" spacing={2}>
                  ...
                  <IconButton 
                    onClick={() =>
                      createConversation({ type: "DIRECT", participantInfos: [] })
                        .then((resp) => {
                  ...
                  >
                    <ListItemAvatar>
                      <Badge
                        ...
                        sx={{
                          "& .MuiBadge-badge": {
                            animation: (conversation as any).unread ? "pulse 2s infinite" : "none",
                          }
                        }}
                      >
                    ...
                    <ListItemText
                      primary={
                        <Typography
                          variant="subtitle2"
                          sx={{
                            fontWeight: (conversation as any).unread ? 600 : 500,
                            fontSize: "1rem",
                            color: (conversation as any).unread ? "#2c3e50" : "#34495e",
                            alignItems: "center",
                          }}
                        >
                          {conversation.type === "DIRECT"
                      ...
                      secondary={
                        ...
                        >
                          <Typography
                            ...
                            variant="body2"
                            sx={{
                              fontWeight: (conversation as any).unread ? 500 : 400,
                              fontSize: "0.875rem",
                              color: "#7f8c8d",
                              maxWidth: "200px",
            ...
            <>
              ...
              >
                <Stack direction="row" alignItems="center" spacing={2}>
                  ...
                  >
                    {selectedConversation.type === "DIRECT"
                      ? selectedConversation.directName?.charAt(0).toUpperCase()
                  ...
                  <Box sx={{ flexGrow: 1 }}>
                    ...
                    {selectedConversation.type === "GROUP" && (
                      ...
                      >
                        {selectedConversation.participantInfos?.length} members
                      </Typography>
                    )}
                  </Box>
                              ...
                              {msg.attachmentFileUrl && (
                                <Box sx={{ mt: 1 }}>
                                  {msg.messageType === "IMAGE" ? (
                                    ...
                                    >
                                      <FilePresent sx={{ mr: 1, fontSize: 16 }} />
                  ...
                  <IconButton
                    ...
                    sx={{
                      backgroundColor: messageInput?.content.trim()
                        ? "#3b82f6"
                        : "#e2e8f0",
                      color: messageInput?.content.trim() ? "white" : "#94a3b8",
                      width: 48,
                      height: 48,
                      "&:hover": {
                        backgroundColor: messageInput?.content.trim()
