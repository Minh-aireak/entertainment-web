...
import com.MyProject.comment_service.repository.httpclient.ProfileClient;
...
@Slf4j
public class CommentProfileExternalService {
    ...
    public Map<String, UserProfileResponse> getBulkUserProfilesFallback(Set<String> userIds, Throwable throwable) {
        ...
        log.warn("Fallback triggered while fetching profiles for comment-service users {}: {}",
                userIds,
