...
const filterChipSx = (selected: boolean) => ({
  height: 38,
  px: 0.5,
  fontSize: '0.875rem',
  ...
  bgcolor: selected ? undefined : 'rgba(255,255,255,0.03)',
    ...
    <Box sx={{ minHeight: '100vh', pb: 8 }}>
      <Box
        sx={{
          ...
          mb: 6,
          background:
            'linear-gradient(135deg, rgba(0,168,78,0.22) 0%, rgba(18,18,18,1) 45%, rgba(20,20,20,1) 100%)',
          ...
          <Box sx={{ mb: 3 }}>
            ...
            <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1 }}>
              <Chip
                ...
                sx={filterChipSx(filters.genre === 'ALL')}
              />
              {GENRE_VALUES.map((g) => (
                <Chip
                  key={g}
                  ...
                  sx={filterChipSx(filters.genre === g)}
                />
              ))}
            </Box>
          </Box>
          ...
          <Box sx={{ mb: 3 }}>
            ...
            <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1 }}>
              <Chip
                ...
                sx={filterChipSx(filters.country === 'ALL')}
              />
              {COUNTRY_VALUES.map((c) => (
                <Chip
                  ...
                  sx={filterChipSx(filters.country === c)}
                />
              ))}
            </Box>
          </Box>
