    ...
    <Box sx={{ bgcolor: 'background.default', minHeight: '100vh' }}>
      ...
      <Container maxWidth="lg" sx={{ py: 4 }}>
        ...
        <Box sx={{ mb: 5 }}>
          ...
          <Paper sx={{ borderRadius: 3, bgcolor: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)', p: 2 }}>
                  ...
                  return (
                      ...
                      <ButtonBase
                        ...
                        sx={{
                          ...
                          aspectRatio: '2 / 1',
                          borderRadius: 1,
                          bgcolor: isActive ? theme.palette.primary.main : 'rgba(255,255,255,0.04)',
        ...
        <Paper sx={{ borderRadius: 3, bgcolor: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.05)' }}>
          <Tabs
            value={activeTab}
