      ...
      <Box sx={{ p: 3, flex: 1, display: 'flex', flexDirection: 'column', gap: 2 }}>
        ...
        <Box sx={{ mt: 'auto', display: 'flex', gap: 1.5 }}>
          <Button
            ...
            sx={{
              borderRadius: 2.5,
              bgcolor: variant === 'my' ? 'primary.main' : 'rgba(255,255,255,0.08)',
    ...
    <Box sx={{ minHeight: '100vh', pb: 8 }}>
      <Box
        sx={{
          ...
          mb: 6,
          background:
            'linear-gradient(135deg, rgba(120,80,255,0.22) 0%, rgba(0,168,78,0.15) 40%, rgba(18,18,18,1) 85%)',
          ...
          <Grid size={{ xs: 12, md: 5, lg: 4 }}>
            <Paper
              sx={{
                ...
                top: 96,
                backgroundImage:
                  'linear-gradient(180deg, rgba(0,168,78,0.08) 0%, rgba(255,255,255,0.03) 100%)',
          ...
          <Grid size={{ xs: 12, md: 7, lg: 8 }}>
            <Box sx={{ mb: 6 }}>
              ...
              {publicRooms.length === 0 ? (
                <Paper sx={{ p: 4, textAlign: 'center', borderRadius: 3, bgcolor: 'rgba(255,255,255,0.03)' }}>
