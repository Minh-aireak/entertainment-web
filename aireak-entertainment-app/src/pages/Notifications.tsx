...
const NotificationsPage: React.FC = () => {
  ...
  return (
    <Container maxWidth="lg" sx={{ py: { xs: 3, md: 6 } }}>
      ...
      <Paper elevation={0} sx={{ overflow: 'hidden', borderRadius: 4, bgcolor: '#141414', border: '1px solid rgba(255,255,255,0.06)' }}>
        {loading ? (
          <Box sx={{ p: 2 }}>
          ...
          <Box sx={{ py: 12, px: 3, textAlign: 'center' }}>
            <NotificationsIcon sx={{ fontSize: 72, color: 'rgba(255,255,255,0.12)', mb: 2 }} />
          ...
          pageData.data.map((notification, index) => (
            <Box
              ...
              sx={{
                ...
                borderBottom: index < pageData.data.length - 1 ? '1px solid rgba(255,255,255,0.05)' : 'none',
              }}
            >
